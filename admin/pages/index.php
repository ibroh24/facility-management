...
<head>
    ...
    <title>Facility Mgmt - Admin Login</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <!-- <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="../../assets/images/facility.png" alt="logo" /></span>
                    </div> -->
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="" method="post" autocomplete="off">

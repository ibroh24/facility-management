...
<head>
    ...
    <title>Facility Mgmt - Register User</title>
    <!-- Custom CSS -->
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-success float-right" type="submit">Register User</button>
                                        <a href="index.php" class="btn btn-info" id="to-recover" type="button">Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>

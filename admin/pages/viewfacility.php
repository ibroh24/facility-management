                                        ...
                                        <div class="card-body">
                                                ...
                                                <table id="zero_config" class="table table-bordered table-striped">
                                                    <thead style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255); font-weight: bold; font-size: 16px;">
                                                        <tr>
                                                            ...
                                                            <th><b>Item Receipt Number</b></th>
                                                            <th><b>Item Amount</b></th>
                                                            <th><b>Item Purchase Date</b></th>
                                                            <th><b>Item Model</b></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php populateAllItem($dbConnect); ?>
                                                        <?php deleteItems($dbConnect); ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <button style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255); font-weight: bold; font-size: 16px; margin-top: 20px;">
                                                    <a style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255); font-weight: bold; font-size: 16px;" class="btn" href="facilitysetup.php">Add New Item</a>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input  class="form-control" value="<? php // echo $itemname; 
                                            ?>" disabled type="text" name="itemname" id="">
      </div>
       </div>
  </div>

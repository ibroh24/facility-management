        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark active"><i class="fas fa-user-circle"></i><span class="hide-menu">Users </span></a>
                        <ul aria-expanded="false" class="collapse first-level">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <form class="form-group" method="post" autocomplete="off">
                            <div class="card-body">
                                <h4 style="background-color: rgb(3, 169, 243); height:50px; padding-top: 20px; padding-left: 10px; color: rgb(255, 255, 255);">Enter New User Data</h4>
                                <div class="border-top">
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                        <label for="fname" class="control-label"><b>First Name</b></label>
                                            <input type="text" class="form-control" name="firstname" id="itemname" placeholder="Enter First Name">
                                        </div>


                                        <div class="col-md-6">
                                        <label for="fname" class="control-label"><b>Last Name</b></label>
                                            <input type="text" class="form-control" name="lastname" id="itemname" placeholder="Enter Last Name">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="lname" class="control-label col-form-label"><b>Username</b></label>
                                            <input type="text" class="form-control" name="username" id="lname" placeholder="Enter Username">
                                        </div>


                                        <div class="col-md-6">
                                        <label for="lname" class="control-label col-form-label"><b>Password</b></label>
                                            <input type="password" class="form-control" name="password" id="lname" placeholder="Enter Password">
                                        ...
                                        <label for="lname" class="control-label col-form-label"><b>Email</b></label>
                                            <input type="email" class="form-control" name="email" id="lname" placeholder="Enter Email">
                                        </div>

                                        <div class="col-md-6">
                                        <label class="control-label"><b>User Type</b></label>
                                        <select class="form-control custom-select" name="usertype" style="width: 100%; height:36px;">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <b><input type="submit" style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255);" class="btn btn-block" name="addusers" value="Add User"></b>
                                    </div>
                                </div>
                                <?php  insertUserData($dbConnect); ?>
                                    </div> 
                                    </div>                                        

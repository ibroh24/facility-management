        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">View & Edit Users</h4>
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="manageUsers.php">View Users</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <form class="form-group">
                            <div class="card-body">
                                <h4 class="card-title">View & Edit Users</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php populateAllUsers($dbConnect); ?>
                                            <?php deleteUsers($dbConnect); ?>
                                        </tbody>
                                    </table>
                                    <div>
                                        <button style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255); font-weight: bold; font-size: 16px; margin-top: 20px;">
                                    <a style="background-color: rgb(3, 169, 243); color: rgb(255, 255, 255); font-weight: bold; font-size: 16px;" class="btn" href="addUsers.php">Add New User</a>
                                    </button>
                                </div>
                                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label for="exampleInputEmail1">Are you sure you wan to delete Item:</label>
        <input  class="form-control" value="<?php //echo $itemname; ?>" disabled type="text" name="itemname" id="">
      </div>
       </div>
  </div>
      <div class="modal-footer">
        <button name="delete" id="delete" class="btn btn-danger">Delete Item</button>
